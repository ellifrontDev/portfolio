...
import img1 from "../img/motion.jpg"
import img2 from "../img/tmdb.jpg"
import img3 from "../img/planet.jpg"
                ...
                <div  className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
                    ...
                    <div style={{backgroundImage: `url(${img1})`}}
                        ...
                        <div className="opacity-0 group-hover:opacity-100">
                            ...
                            <div className="pt-8 text-center">
                                <a className="m-4" href="https://motion-blue.vercel.app/">
                    ...
                    <div style={{backgroundImage: `url(${img2})`}}
                        ...
                        <div className="opacity-0 group-hover:opacity-100">
                            ...
                            <div className="pt-8 text-center">
                                <a className="m-4" href="https://ts-moviee.vercel.app/">
                                    <button className="text-center rounded-lg px-4 py-3 bg-white text-gray-700 font-bold text-lg">Demo</button>
                                </a>
                                <a  className="m-4"href="/">
                                    <button className="text-center rounded-lg px-4 py-3 bg-white text-gray-700 font-bold text-lg">Code</button>
                    ...
                    <div style={{backgroundImage: `url(${img3})`}}
                        ...
                        <div className="opacity-0 group-hover:opacity-100">
                            ...
                            <div className="pt-8 text-center">
                                <a className="m-4" href="http://project7744586.tilda.ws/">
                                    <button className="text-center rounded-lg px-4 py-3 bg-white text-gray-700 font-bold text-lg">Demo</button>
                                </a>
                                <a  className="m-4"href="/">
                                    <button className="text-center rounded-lg px-4 py-3 bg-white text-gray-700 font-bold text-lg">Code</button>
